...
- `Windows <https://codeberg.org/mikf/gallery-dl/releases/download/v1.32.13/gallery-dl.exe>`__
  (Requires `Microsoft Visual C++ Redistributable Package (x86) <https://aka.ms/vs/17/release/vc_redist.x86.exe>`__)
- `Linux   <https://codeberg.org/mikf/gallery-dl/releases/download/v1.32.13/gallery-dl.bin>`__
